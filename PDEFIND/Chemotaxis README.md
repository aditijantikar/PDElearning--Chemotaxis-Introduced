...
You can view the detailed report here: [BENG_227_Project (1).pdf](https://github.com/user-attachments/files/22712589/BENG_227_Project.1.pdf)

To run the code, please clone the repository and execute it locally, as several dependencies are required.
